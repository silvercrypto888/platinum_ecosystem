...
Lanchester's Laws _greatly simplify_ combat simulation for massive battles involving millions or even _billions of participants_, without having to simulate each agent's combat individually. This allows instant combat resolution, even in a colossal multiplayer match within an onchain strategy game. Extensions of Lanchester's equations can even simulate the remaining army forces from massive battles, not just the win or loss itself.
