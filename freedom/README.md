...
The main command is this one: `spl-token create-token --program-id TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb --decimals %DECIMALS% --interest-rate %INT_RATE% --enable-non-transferable --enable-metadata`
